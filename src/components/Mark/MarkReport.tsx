...
export const MarkReport: FC<MarkProps> = ({ ...props }) => {
  const id = getId();
    ...
    <Mark {...props}>
      <svg fill="none" viewBox="0 0 144 144" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill={`url(#paint0_linear_3515_815-${id})`}
        />
        <path
          ...
          fill={`url(#paint1_linear_3515_815-${id})`}
        />
        <path
          d="M42.1963 42.3198L38.7963 55.9598H46.3163L42.9163 42.3198H42.1963Z"
          fill={`url(#paint2_linear_3515_815-${id})`}
        />
        <path
          clipRule="evenodd"
          ...
          fill={`url(#paint3_linear_3515_815-${id})`}
          fillRule="evenodd"
        />
        <defs>
          <linearGradient
            gradientUnits="userSpaceOnUse"
            id={`paint0_linear_3515_815-${id}`}
            x1="67.9904"
            x2="67.9904"
            y1="78"
            y2="138"
