...
export const MarkProductMuted: FC<MarkProps> = ({ ...props }) => {
  const id = getId();
    ...
    <Mark {...props}>
      <svg fill="none" viewBox="0 0 144 144" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill={`url(#paint0_linear_3704_505-${id})`}
        />
        <path
          ...
          fill={`url(#paint1_linear_3704_505-${id})`}
        />
        ...
        <defs>
          <linearGradient
            ...
            id={`paint0_linear_3704_505-${id}`}
            x1="122"
            x2="42.162"
            y1="72"
            y2="85.5162"
          >
            <stop stopColor="#C3C8D5" />
            <stop offset="1" stopColor="#9FA5B3" />
          </linearGradient>
          <linearGradient
            gradientUnits="userSpaceOnUse"
            id={`paint1_linear_3704_505-${id}`}
            x1="144"
            x2="79.4604"
            y1="72"
            y2="-2.28408"
          >
            <stop stopColor="#C7CBD6" />
            <stop offset="0.449098" stopColor="#BEC4D2" />
            <stop offset="1" stopColor="#A8AEBB" />
          </linearGradient>
        </defs>
      </svg>
    </Mark>
